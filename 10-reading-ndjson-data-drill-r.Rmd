...
library(tidyverse)
```
```{r 07-query-01, message=FALSE, warning=FALSE, cache=TRUE}
library(sergeant)
library(tidyverse)
...
```{r 07-query-02, message=FALSE, warning=FALSE, cache=TRUE}
...
```
```{r 07-vis-01, message=FALSE, warning=FALSE, fig.width=7, fig.height=6}
library(hrbrthemes)
