...
```{r 04-cholera-query-1, message=FALSE, warning=FALSE}
library(sergeant)
library(tidyverse)
...
```{r 04-cholera-wrangle, message=FALSE, warning=FALSE}
...
```{r 04-chart-01, message=FALSE, warning=FALSE, fig.width=7, fig.height=3}
library(hrbrthemes)
